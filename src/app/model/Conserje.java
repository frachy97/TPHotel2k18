...
public class Conserje extends Usuario {
            ...
            while (repetir == true) {
                ...
                switch (opcion) {
                    case "1":
                        ...
                        IOGenericoUtil.esciribirObjeto(hotel.getClientes(), Archivos.CLIENTES);
                        repetir = false;
                        break;
                    case "2":
    ...
    public void checkIn(Reserva reserva) {
        if (reserva.isConfirmada() == false) {
            ...
            System.out.println(reserva.getCliente().getHistorial().get(0));
        } else {
    ...
    public void modificarCliente(Scanner scan, Hotel hotel) {
        ...
        if (Integer.valueOf(opcion) >= 1 && Integer.valueOf(opcion) <= 5) {
            IOGenericoUtil.esciribirObjeto(hotel.getClientes(), Archivos.CLIENTES);
        }
    }
