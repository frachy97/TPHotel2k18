...
public class Conserje extends Usuario {
    ...
    public Reserva altaReserva(Scanner input, Hotel hotel) {
        ...
        while (!confirmarReserva) {
            ...
            Habitacion hAux = hotel.seleccionarHabitacionParaReserva(input);
    ...
    /* 05/06/2018
     * Retorna el precio total de la reserva, incluyendo consumos,
     * para que sea atrapado por el controlador y lo sume a la variable Double ingresos
     * dentro de la clase Hotel
     */
    public double checkOut(Reserva reserva) {
        /* Calculo la cantidad de dias que duro la reserva */
        int periodo = (int) ChronoUnit.DAYS.between(reserva.getFechaIngreso(),
                reserva.getFechaSalida());
        double precioTotal = reserva.getHabitacion().getPrecioPorDia()
                * periodo;
